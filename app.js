...
// URL DE TU PROYECTO EN VERCEL (YA CONFIGURADA)
...
bot.start((ctx) => {
    ...
    ctx.replyWithMarkdownV2(
        ...
        `Estás en la red AXON\\. Aquí tu entrenamiento ayuda directamente a personas sin hogar y animales rescatados [cite: 2026-02-14]\\.\n\n` +
        `📢 *TU LINK DE REFERIDO:* \n` +
        `\`${referralLink}\``,
...
// Mensaje de consola para saber que el bot arrancó
